...
int main(int argc, char **argv) {
    ...
    float x = 0, y = 0;
    ros::param::get("/calibration_default/closeCam/point1/x", x);
    ros::param::get("/calibration_default/closeCam/point1/y", y);
    ...
    ros::param::get("/calibration_default/closeCam/point2/x", x);
    ros::param::get("/calibration_default/closeCam/point2/y", y);
    ...
    ros::param::get("/calibration_default/closeCam/point3/x", x);
    ros::param::get("/calibration_default/closeCam/point3/y", y);
    ...
    ros::param::get("/calibration_default/closeCam/point4/x", x);
    ros::param::get("/calibration_default/closeCam/point4/y", y);
    ...
    ros::param::get("/calibration_default/farCam/point1/x", x);
    ros::param::get("/calibration_default/farCam/point1/y", y);
    far_imagePoints[0] = cv::Point2d(x, y);
    far_imagePoints[0].x *= imgCols;
    far_imagePoints[0].y *= imgRows;
    cout << far_imagePoints[0] << endl;
    ros::param::get("/calibration_default/farCam/point2/x", x);
    ros::param::get("/calibration_default/farCam/point2/y", y);
    far_imagePoints[1] = cv::Point2d(x, y);
    far_imagePoints[1].x *= imgCols;
    far_imagePoints[1].y *= imgRows;
    cout << far_imagePoints[1] << endl;
    ros::param::get("/calibration_default/farCam/point3/x", x);
    ros::param::get("/calibration_default/farCam/point3/y", y);
    far_imagePoints[2] = cv::Point2d(x, y);
    far_imagePoints[2].x *= imgCols;
    far_imagePoints[2].y *= imgRows;
    cout << far_imagePoints[2] << endl;
    ros::param::get("/calibration_default/farCam/point4/x", x);
    ros::param::get("/calibration_default/farCam/point4/y", y);
